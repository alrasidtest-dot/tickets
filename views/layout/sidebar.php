...
$icon = [
    ...
    'departments'=> '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18M6 21V7l6-4 6 4v14"/><path d="M9 9h.01M9 13h.01M9 17h.01M15 9h.01M15 13h.01M15 17h.01"/></svg>',
...
$nav['manager'] = [
    ['manager_dashboard', 'nav_tickets', $icon['tickets']],
];
$nav['admin'] = [
    ['admin_tickets',     'nav_tickets',     $icon['tickets']],
    ['admin_users',       'nav_users',       $icon['users']],
    ['admin_departments', 'nav_departments', $icon['departments']],
